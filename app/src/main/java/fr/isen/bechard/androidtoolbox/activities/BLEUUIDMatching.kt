...
enum class BLEUUIDMatching (val uuid: String, val title: String){
    ...
    CUSTOM_CHARACTERISTIC_1("466c5678-f593-11e8-8eb2-f2801f1b9fd1","Caractéristic spécifique 1"),
    CUSTOM_CHARACTERISTIC_2("466c9abc-f593-11e8-8eb2-f2801f1b9fd1","Caractéristic spécifique 2"),
